...
public class JoinQueryUtilities<R extends Rectangle<R> & Entity<? super R>> {
	...
	public ArrayList<Pair<Pair<R, Integer>, Pair<R, Integer>>> planeSweep(ArrayList<Pair<R, Integer>> mbrsRtree1,
			ArrayList<Pair<R, Integer>> mbrsRtree2) {
	...
	private void loopInterno(Pair<R, Integer> t, int naoMarcado, ArrayList<Pair<R, Integer>> rs,
			ArrayList<Pair<Pair<R, Integer>, Pair<R, Integer>>> saida, Boolean primeiroLoop) {
		int k = naoMarcado;
